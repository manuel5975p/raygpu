...
RAYGPU_SHARED :: #config(RAYGPU_SHARED, false)
...
when ODIN_OS == .Windows {
	...
	foreign import lib {
		...
		"linux/libraygpu.so" when RAYGPU_SHARED else "linux/libraygpu.a",
		"system:dl",
		"system:pthread",
        "system:stdc++",
	...
	foreign import lib {
		"macos/libraylib.550.dylib" when RAYGPU_SHARED else "macos/libraylib.a",
...
Texture :: struct {
	id:      c.uint64_t,              // OpenGL texture id
...
RenderTexture :: struct {
	...
	texture1: Texture,              // Color buffer attachment texture
	texture2: Texture,              // Color buffer attachment texture
	texture3: Texture,              // Color buffer attachment texture
	textureMultisample: Texture,    // Color buffer attachment texture
	depth:   Texture,               // Depth buffer attachment texture
	colorAttachmentCount:   c.uint, // Depth buffer attachment texture
} 
