...
RGAPI Model LoadModelFromMesh(Mesh mesh)
{
    Model model = { 0 };
...
RGAPI void DrawModelEx(Model model, Vector3 position, Vector3 rotationAxis, float rotationAngle, Vector3 scale, Color tint)
{
    ...
    Matrix matTransform = MatrixMultiplySwap(MatrixMultiplySwap(matScale, matRotation), matTranslation);
...
RGAPI void DrawMesh(Mesh mesh, Material material, Matrix transform){
